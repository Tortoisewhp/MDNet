...
def get_loader(cfg):
    ...
    test_dataset = instantiate_from_config(cfg.test_dataset.NC4K)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--results_folder', type=str, default='RGBT_irseg', help='None for saving in wandb folder.')
    ...
    print('cfg.diffusion_model',cfg.diffusion_model)
